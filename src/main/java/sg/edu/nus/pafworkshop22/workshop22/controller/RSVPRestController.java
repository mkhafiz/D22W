...
public class RSVPRestController {
    ...
    public ResponseEntity<String> getAllCustomer(@RequestParam(required = false) String q) {
        ...
        return ResponseEntity
                ...
                // .status(HttpStatus.NOT_FOUND)  --> to display 404 error (can use .body as well)
    ...
    public ResponseEntity<String> countRSVP() {
        JsonObject resp;
        // Query the database for the rsvps and return integer
    ...
    public ResponseEntity<String> postRSVP(@RequestBody String json) {
        ...
        rsvpResult = rsvpSvc.insertPurchaseOrder(rsvp);  // insertRSVP ???
        resp = Json.createObjectBuilder()
